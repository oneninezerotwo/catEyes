    ...
    <div class="select-block" style="height: 379.234px;">
      <div class="seat-block-wrap" style="visibility: visible;">
        ...
        >
          ...
          >
            <div
              :class="{wrap:true,active: (selectX[activeNum-1]==index&&selectY[activeNum-1]==index1) ||(selectX[activeNum-2]==index&&selectY[activeNum-2]==index1)||(selectX[activeNum-3]==index&&selectY[activeNum-3]==index1) ||(selectX[activeNum-4]==index&&selectY[activeNum-4]==index1) }"
              :key="index1"
    ...
    active(index1, index2) {
      ...
      if (this.activeNum >= 4) {
        ...
        if (this.isok) {
          ...
          this.$store.state.select_data[this.activeNum] = [index1+1, index2+1];
